...
from constants import CARD_HEIGHT, CARD_WIDTH, IMAGE_SIZE
...
def parse_args():
	...
	parser.add_argument('src_folder', help = 'Where raw sized cards or background images are present', type = str)
	parser.add_argument('dest_folder', help = 'Where to store resized cards or background images', type = str)	
...
if __name__ == "__main__":
	...
	if args.is_bg_img == 1:
		...
		base_resize_images(args.src_folder, args.dest_folder, (CARD_HEIGHT, CARD_WIDTH), should_rename = False)
		print('Resizing of card image is complete')
